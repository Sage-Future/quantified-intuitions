      ...
      <div className="py-8 max-w-prose mx-auto">
        <div className="max-w-prose mx-auto flex justify-between ">
          ...
          <div className="prose">
            ...
            <p className="my-0 text-gray-500 text-[12px]">Lower = better </p>
            <h2 className="my-0">
            ...
            {fermiComplete && <>
              ...
              <p className="my-0 text-gray-500 text-[12px]">Higher = better </p>
              <h2 className="my-0">
        ...
        {/* {(questionComplete || challengeComplete) && <ChallengeLeaderboard
          ...
          teamId={teamId}
          latestQuestionIndex={challengeComplete ? undefined : fermiQuestionNum}
        />} */}
      </div>
    </div>
  )
