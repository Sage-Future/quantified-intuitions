      ...
      <div className="bg-gray-50 grow">
        <div className="px-4 pt-12 lg:pt-16 mx-auto max-w-6xl">
          <div className="prose mx-auto">
            ...
            <Image
              src={"/anki_front.png"}
              alt="An Anki card that lets you input a range"
              width={700}
              height={595}
            />
            ...
            <Image
              src={"/anki_back.png"}
              alt="The back of the card shows your score"
              width={700}
              height={595}
            />
            ...
            <div className="flex justify-center">
              <Image
                src={"/anki_scores.png"}
                alt="See your Anki calibration scores"
                width={345}
                height={700}
              />
            </div>
            ...
            <p>
              {
                "1. Open Anki, go to Tools → Addons → Get addons, and paste this code:"
              }{" "}
              <b>694813595</b>
            </p>
            ...
            <p>
              {"2."}{" "}
              <Link href="Anki_with_uncertainty__example_deck.apkg">
                {"Download and open the example deck"}
              </Link>
              {" to add the Interval card type"}
            </p>
            ...
            <div className="flex justify-center">
              <Image
                src={"/anki_add_card.png"}
                alt="How to add an Anki interval card"
                width={345}
                height={440}
              />
            </div>
            ...
            <p>
              You can rate this plugin on{" "}
              <Link href={"https://ankiweb.net/shared/info/694813595"}>
                AnkiWeb
              </Link>
              .
            </p>
            ...
            <p>
              ...
              <Link
                href={"https://github.com/Sage-Future/anki-with-uncertainty"}
              >
                GitHub
              </Link>
              .
            ...
            <p>
              ...
              <a href="mailto:hello@sage-future.org">hello@sage-future.org</a>{" "}
              or on <Link href="https://discord.gg/mt9YVB8VDE">Discord</Link>.
            </p>

            <p>
              See also{" "}
              <Link href="https://github.com/JulHeg/AnkiCalibrateAddon">
                Julius Hege&apos;s Anki Calibrate plugin
              </Link>
              .
            </p>
            ...
            <div className="flex flex-wrap gap-2 py-4">
              {apps
                .filter((app) => app.name !== "Anki with Uncertainty")
                .map((app) => (
          ...
          <div className="max-w-xs mt-12 mb-6 m-auto">
            <MailingListSignup
              buttonText="Subscribe to hear about our next tool"
              tags={["homepage"]}
            />
          </div>
        </div>
