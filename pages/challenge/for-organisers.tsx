...
const Faq = () => {
  const faqs = [
    ...
    },
    {
      question: "How long?",
      answer:
        "Around 40 mins. If you want a longer event, you could do some pastcasting questions afterwards.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Super easy! To save you time, we'll send you a sample event title, description and Facebook cover photo that you can tailor for your group. All you need to do is get some people together in a room and start playing.",
    },
    {
    ...
    {
      question: "'First monthly' Estimation Game?",
      answer: "A new challenge will drop each month. [Link to method to be notified about the next one]",
    },
    {
    ...
    },
    {
      ...
      answer: "You can email us at adam@sage-future.org.",
    },
    {
  ...
  return (
    <div className="flex flex-col min-h-screen ">
      ...
      <div className="bg-gray-50 grow">
        <div className="max-w-7xl pt-12 px-4 lg:py-16 lg:px-8 mx-auto prose">
          ...
          <p className="mt-12">Host an event for your group members to play our first monthly Estimation Game!</p>
